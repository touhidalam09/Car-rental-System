...
while globalTime <= 7200
    ...
    distance = 4.5;
    exponential = 14;
    [globalTime,delayQueue,queue,peoples,totalMaxQueue3,maxQueue3,totalDelayQueue3,maxdelayQueue3,totalmaxonBus,maxonBus] = loading(globalTime,delayQueue3,queue3,peoples,totalMaxQueue3,maxQueue3,totalDelayQueue3,maxdelayQueue3,totalmaxonBus,maxonBus,probabilites,bus_capacity,loadingTime,unloadingTime,distance,3,exponential);
    fprintf('\n\n :::::--:::::-- Queue1 --:::::--::::: \n');
    pvQvalue3 = queue(1);
    ...
    distance = 1;
    exponential = 10;
    [globalTime,delayQueue,queue,peoples,totalMaxQueue1,maxQueue1,totalDelayQueue1,maxdelayQueue1,totalmaxonBus,maxonBus] = loading(globalTime,delayQueue1,queue1,peoples,totalMaxQueue1,maxQueue1,totalDelayQueue1,maxdelayQueue1,totalmaxonBus,maxonBus,probabilites,bus_capacity,loadingTime,unloadingTime,distance,1,exponential);
    fprintf('\n\n :::::--:::::-- Queue2 --:::::--::::: \n');
    pvQvalue1 = queue(1);
    ...
    distance= 4.5;
    exponential = 24;
    [globalTime,delayQueue,queue,peoples,totalMaxQueue2,maxQueue2,totalDelayQueue2,maxdelayQueue2,totalmaxonBus,maxonBus] = loading(globalTime,delayQueue2,queue2,peoples,totalMaxQueue2,maxQueue2,totalDelayQueue2,maxdelayQueue2,totalmaxonBus,maxonBus,probabilites,bus_capacity,loadingTime,unloadingTime,distance,2,exponential);
    pvQvalue2 = queue(1);
...
fprintf('\nAvg Maximum number in Queue(1): %.3f',(totalMaxQueue1/numberofJobsDone));
fprintf('\nAvg Maximum number in Queue(2): %.3f',(totalMaxQueue2/numberofJobsDone));
fprintf('\nAvg Maximum number in Queue(3): %.3f',(totalMaxQueue3/numberofJobsDone));
...
fprintf('\nAvg Maximum delay in Queue(1): %.3f',(totalDelayQueue1/numberofJobsDone));
fprintf('\nAvg Maximum delay in Queue(2): %.3f',(totalDelayQueue2/numberofJobsDone));
fprintf('\nAvg Maximum delay in Queue(3): %.3f',(totalDelayQueue3/numberofJobsDone));
