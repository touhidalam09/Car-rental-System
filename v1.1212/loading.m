function [ globalTime,delayQueue,queue,peoples,totalMaxQueue,maxQueue,totalDelayQueue,maxdelay,totalmaxonBus,maxonBus] = loading( globalTime,delayQueue,queue,peoples,totalMaxQueue,maxQueue,totalDelayQueue,maxdelayQueue,totalmaxonBus,maxonBus,probabilites,bus_capacity,loadingTime,unloadingTime,distance,location,exponential)
global bus_size;
...
[globalTime,totalDelayQueue,maxdelay] = maximumdelay(globalTime,totalDelayQueue,maxdelayQueue,delayQueue,unloadingTime,loadingTime,distance,exponential);
